...
const BackButton: React.FC<{ onClose: () => void }> = ({ onClose }) => (
  <button
    onClick={onClose}
    className="mt-[100px] mr-[50px] fixed top-4 right-4 text-white font-semibold w-12 h-12 rounded-full bg-black z-[110] flex items-center justify-center hover:bg-gray-800 transition-colors duration-200 shadow-lg"
    aria-label="Close"
  >
    <svg
      width="20"
...
export const WorkDetails: React.FC<WorkDetailsProps> = ({ work, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-white z-[100] flex flex-col justify-start overflow-y-auto ">
