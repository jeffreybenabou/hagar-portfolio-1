...
export const Header = ({ onCloseWorkDetails }: HeaderProps) => {
  // State
  ...
  const handleNavClick = (itemId: string) => {
    ...
    onCloseWorkDetails(); // Close WorkDetails when navigating
  };
  ...
  return (
    <div className={'sticky w-full top-0 z-[110]'}>
      <header
        className="w-full py-4 px-20 flex justify-between items-center sticky top-0 z-[110]"
        style={headerStyles}
      >
        {/* Logo */}
        <img
